            ...
            <div class="col-lg-6 col-sm-12 col-md-8 col-lg-push-3 col-md-push-2">
                ...
                <form id="mm_profile_form" action="{{route('matchmaker.update',$user->id)}}" method="post"
                        ...
                        <div id="upload_image" class="upload_image" action="{{ route('image.upload') }}">
                            <div class="dropzone">
                                <div class="dz-message">
                                    @if(isset($user->image))
                                        <img id="post-thumb-prev" src="{{asset('uploads/'.$user->image)}}"
                                             alt="{{$user->image}}"/>
                                    @else
                    ...
                    <div class="lf_form_input col-md-12">
                        ...
                        <input type="text" name="name" value="{{$user->name}}" required><span
                                class="err_name"></span>
                    </div>
                    <div class="lf_form_input col-md-12">
                        <label for="email">Email (Required*)</label>
                        <input type="email" name="email" value="{{$user->email}}" required><span
                                class="err_email"></span>
                    </div>
                    <div class="lf_form_input col-md-12">
                        <span>***If you want to change your password then fill the password field.***</span>
                        <label for="password">Password</label>
                        <input type="password" name="password_1" placeholder="Enter your Password"><span
                                class="err_password"></span>
                    </div>
                    <div class="lf_form_input col-md-12">
                        <label for="password">Re-Password</label>
                        <input type="password" name="password_2" placeholder="Re-Enter your Password"><span
                                class="err_password"></span>
                    </div>
                    <div class="col-md-12">
